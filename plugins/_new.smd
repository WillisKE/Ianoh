let {
 ...
 smd(
  ...
  async (message) => {
    const channelMessage = `WILLIS-MD SUPPORT_\n *𝐋𝐈𝐍𝐊:* https://whatsapp.com/channel/0029VaZ8Q0Y1XquZ673Uvs0m\n\n ${Config.botname} *WORKS*`;
...
smd(
  ...
  async (message) => {
    const SupportMsg = `WILLIS MD SUPPORT GROUP\n\n *ʟɪɴᴋ:*https://chat.whatsapp.com/KlFKWN3QWq04DKeAdjk8gw \n\n ${Config.botname} *WORKS*`;
